...
export const scrapers = pgTable("scraper", {
  id: text("id").notNull().primaryKey(),
  name: text("name").notNull(),
  url: text("url").notNull(),
  selectors: text("selectors"), // JSON string or serialized
  roomId: text("roomId")
    .notNull()
...
export const usage_logs = pgTable("usage_log", {
  id: text("id").notNull().primaryKey(),
  userId: text("userId")
    .notNull()
    .references(() => users.id, { onDelete: "cascade" }),
  scraperId: text("scraperId")
    .notNull()
